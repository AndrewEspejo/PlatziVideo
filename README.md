...
En esta sección crearemos un container para cuando alguno de los usuarios tipee alguna ruta que no existe pueda observar un error 404 y se le indique que dicha ruta no está disponible.

Como en los casos anteriores, creamos el container y le asignamos sus respectivos estilos
...
Este componente debe establecerse con la jerarquia que estamos utilizando. Utilizaremos **React.fragment** 
